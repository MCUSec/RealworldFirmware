...
public class Constant {
    ...
    // config
    public final static String DIRECTORY_NAME = "/tmp/firmxaytest";
    ...
    public final static byte DF = (byte) 0xDF; // second byte (XX DF)
    public final static byte PUSH2 = (byte) 0xB4; // second byte (XX B4)
    public final static byte E0 = (byte) 0xE0; // second byte (XX E0)
